...
public class BeerRestClientResourceV2 {
    ...
    public Response getBeers() {
        return Response.ok(
                this.beerRestClientService.getAllBeers(ApiVersionEnum.V2.getVersion())
        ).build();
    }
    ...
    public Response getBeer(@PathParam("id") long id) {
        return Response.ok(
                this.beerRestClientService.getBeerByName(id, ApiVersionEnum.V2.getVersion())
        ).build();
    }
    ...
    public Response getBeer(@PathParam("name") String name) {
        return Response.ok(
                this.beerRestClientService.getBeerByName(name, ApiVersionEnum.V2.getVersion())
        ).build();
    }
    ...
    public Response createBeer(@RequestBody BeerClientDTOV2 beerDTO) {
        return beerRestClientService.createBeer(ApiVersionEnum.V2.getVersion(), beerDTO);
    }
    ...
    public Response updateBeerName(@PathParam("id") Long id, @RequestBody String name) {
        return beerRestClientService.updateBeerName(id, ApiVersionEnum.V2.getVersion(), name);
    }
    ...
    public Response updateBeer(@PathParam("id") Long id, @RequestBody BeerClientDTOV2 beerClientDTO) {
        return beerRestClientService.updateBeer(id, ApiVersionEnum.V2.getVersion(), beerClientDTO);
    }
    ...
    public Response deleteBeer(@PathParam("id") Long id) {
        return beerRestClientService.deleteBeer(id, ApiVersionEnum.V2.getVersion());
    }
}